...
class Game:
    ...
    def on_init(self):
        ...
        self._snake_image = pygame.image.load("C:\\Users\\paray\\OneDrive\\Desktop\\PROGRAMMING\\project folder\\snake with pygame\\game2\\game2\\snake.png").convert()
        self._apple_image = pygame.image.load("C:\\Users\\paray\\OneDrive\\Desktop\\PROGRAMMING\\project folder\\snake with pygame\\game2\\game2\\apple.png").convert()
