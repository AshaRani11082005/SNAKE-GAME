...
class Game:
    ...
    def on_init(self):
        ...
        self._snake_image = pygame.image.load("game2\\game2\\snake.png").convert()  
        self._apple_image = pygame.image.load("game2\\game2\\apple.png").convert()
    ...
    def on_render(self):
        ...
        lives = self.name_font.render(f"Lives: {self.player.lives}", True, (255, 255, 55))
        self._display_surf.blit(lives, (0, 440))
    ...
    def game_play_logic(self):
        ...
        if self.player.x < 0 or self.player.x >= 640 or self.player.y < 0 or self.player.y >= 480:
            self.player.lives -= 1
            self.player.x = 0
            self.player.y = 0
